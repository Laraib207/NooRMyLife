...
export default function ContactCTA() {
  ...
  const socialLinks = [
    { icon: <FiGithub className="w-5 h-5" />, label: 'GitHub', href: '#', color: 'hover:text-indigo-400' },
    { icon: <FiLinkedin className="w-5 h-5" />, label: 'LinkedIn', href: '#', color: 'hover:text-blue-400' },
    { icon: <FiTwitter className="w-5 h-5" />, label: 'Twitter', href: '#', color: 'hover:text-sky-400' },
    { icon: <FiMessageCircle className="w-5 h-5" />, label: 'WhatsApp', href: '#', color: 'hover:text-green-400' }
  ]
